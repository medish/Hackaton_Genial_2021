...
import { CoursecontrollerApi, CoursegroupcontrollerApi, DegreecontrollerApi, DepartmentcontrollerApi, ProfessorcontrollerApi, RoomcontrollerApi, TimeconstraintcontrollerApi } from './model/swagger/api';
...
@NgModule({
  ...
  providers: [authInterceptorProviders,TimeconstraintcontrollerApi,RoomcontrollerApi,CoursecontrollerApi,ProfessorcontrollerApi,DegreecontrollerApi,DepartmentcontrollerApi,CoursegroupcontrollerApi],
